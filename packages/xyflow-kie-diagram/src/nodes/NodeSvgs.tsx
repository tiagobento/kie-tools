...
export const containerNodeInteractionRectCssClassName = "xyflow-kie-diagram--node-containerNode-interactionRect";
export const containerNodeVisibleRectCssClassName = "xyflow-kie-diagram--node-containerNode-visibleRect";

  ...
  const onNameChanged = React.useCallback(
    (newName: string) => {
      bpmnEditorStoreApi.setState((s) => {
        renameFlowElement({ definitions: s.bpmn.model.definitions, newName, id: startEvent["@_id"] });
      });
    },
    [startEvent, bpmnEditorStoreApi]
  );

  return <FormSection>StartEventProperties</FormSection>;
}

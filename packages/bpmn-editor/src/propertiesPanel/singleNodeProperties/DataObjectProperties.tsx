  ...
  const onNameChanged = React.useCallback(
    (newName: string) => {
      bpmnEditorStoreApi.setState((s) => {
        renameFlowElement({ definitions: s.bpmn.model.definitions, newName, id: dataObject["@_id"] });
      });
    },
    [dataObject, bpmnEditorStoreApi]
  );

  return <FormSection>DataObjectProperties</FormSection>;
}

  ...
  const onNameChanged = React.useCallback(
    (newName: string) => {
      bpmnEditorStoreApi.setState((s) => {
        renameFlowElement({ definitions: s.bpmn.model.definitions, newName, id: boundaryEvent["@_id"] });
      });
    },
    [boundaryEvent, bpmnEditorStoreApi]
  );

  return <FormSection>BoundaryEventProperties</FormSection>;
}

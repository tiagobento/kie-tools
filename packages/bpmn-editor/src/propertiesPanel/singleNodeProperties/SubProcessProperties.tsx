  ...
  const onNameChanged = React.useCallback(
    (newName: string) => {
      bpmnEditorStoreApi.setState((s) => {
        renameFlowElement({ definitions: s.bpmn.model.definitions, newName, id: subProcess["@_id"] });
      });
    },
    [subProcess, bpmnEditorStoreApi]
  );

  return <FormSection>SubProcessProperties</FormSection>;
}

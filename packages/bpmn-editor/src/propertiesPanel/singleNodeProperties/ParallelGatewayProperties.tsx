  ...
  const onNameChanged = React.useCallback(
    (newName: string) => {
      bpmnEditorStoreApi.setState((s) => {
        renameFlowElement({ definitions: s.bpmn.model.definitions, newName, id: parallelGateway["@_id"] });
      });
    },
    [parallelGateway, bpmnEditorStoreApi]
  );

  return <FormSection>ParallelGatewayProperties</FormSection>;
}

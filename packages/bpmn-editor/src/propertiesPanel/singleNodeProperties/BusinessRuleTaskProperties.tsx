  ...
  const onNameChanged = React.useCallback(
    (newName: string) => {
      bpmnEditorStoreApi.setState((s) => {
        renameFlowElement({ definitions: s.bpmn.model.definitions, newName, id: businessRuleTask["@_id"] });
      });
    },
    [businessRuleTask, bpmnEditorStoreApi]
  );

  return <FormSection>BusinessRuleTaskProperties</FormSection>;
}

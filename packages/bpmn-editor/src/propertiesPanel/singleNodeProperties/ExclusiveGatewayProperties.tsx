  ...
  const onNameChanged = React.useCallback(
    (newName: string) => {
      bpmnEditorStoreApi.setState((s) => {
        renameFlowElement({ definitions: s.bpmn.model.definitions, newName, id: exclusiveGateway["@_id"] });
      });
    },
    [exclusiveGateway, bpmnEditorStoreApi]
  );

  return <FormSection>ExclusiveGatewayProperties</FormSection>;
}

  ...
  const onNameChanged = React.useCallback(
    (newName: string) => {
      bpmnEditorStoreApi.setState((s) => {
        renameFlowElement({ definitions: s.bpmn.model.definitions, newName, id: transaction["@_id"] });
      });
    },
    [transaction, bpmnEditorStoreApi]
  );

  return <FormSection>TransactionProperties</FormSection>;
}

...
export function checkIsValidConnection(
  nodesById: Map<string, RF.Node<BpmnDiagramNodeData>>,
...
export function _checkIsValidConnection(
  sourceNode: { type?: string; data: BpmnDiagramNodeData } | undefined,
  targetNode: { type?: string; data: BpmnDiagramNodeData } | undefined,
